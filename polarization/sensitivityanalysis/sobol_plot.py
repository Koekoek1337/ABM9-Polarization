...
#     'Max. difference in opinion','conformity'],
#     'bounds':[[0,4],[0,6],[0,1],[0,4],[0.2,0.8]],
# }
# #set up data, loading from all csv files
# DATA_DIR = "./data/sobol/"
# datafiles = [dir for dir in os.listdir(DATA_DIR) if dir.startswith("combined_results3")]
...
# sobol_df['indexing'] = sobol_df[['fermi_alpha', 'fermi_b', 'social_factor', 'opinion_max_diff', 'conformity']].sum(axis=1)
