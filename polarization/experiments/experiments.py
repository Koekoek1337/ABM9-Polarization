...
# width, density, network_m, fermi_alpha, fermi_beta, connection_influence, target_connections, opinion_threshold, happiness_threshold
...
experiments = [
    ...
    {"name":"alpha_low",                "values":[20, 0.8, 2, 1, 1, 0.3, 5, 1, 0.8]},
